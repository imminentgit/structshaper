...
public:
	...
	{
		None, Cpp, C, Cs, Python, Lua, Json, Sql, AngelScript, Glsl, Hlsl, Rust
	};
...
private:
	...
	struct LanguageDefinition
	{
		...
		static LanguageDefinition& Python();
		...
		static LanguageDefinition& Cs();
		static LanguageDefinition& Json();
        static LanguageDefinition& Rust();
	};
public:
    LanguageDefinition& GetCurrentLanguageDefinition() { return *mLanguageDefinition; }
private:
