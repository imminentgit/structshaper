 ...
 *
 *  @analysis Native or system settings limitation.  Pick another
 ...
 *  this error.
 *
 *  @analysis Native or platform version limitation.  The error can be ignored
...
/*! @brief Native unavailable or no matching platform was found.
 *
...
/*! @brief Native selection init hint.
 *
 *  Native selection [init hint](@ref GLFW_PLATFORM).
 */
